...
const config = {
    ...
    safelist: [
        ...
        {
            pattern: /(text|stroke)-(green|yellow|blue|violet|rose|red|orange)-500/,
        },
    ],
    theme: {
        extend: {
    ...
    ux: {
        ...
        themes: {
            ...
            dark: {
                "color-scheme": "dark",
                primary: "oklch(70.0% 0.25 40.0)", // Vibrant orange for better contrast
                secondary: "oklch(60.0% 0.2 255.75)", // Updated for better visibility
            ...
            fontSize: {
                ...
                "3xl": [
                    "clamp(1.875rem, 2.4vw, 2.25rem)",
                    { lineHeight: "2.25rem" },
                ], // 30px to 36px
                "4xl": [
                    "clamp(2.25rem, 2.8vw, 3rem)",
                    { lineHeight: "2.5rem" },
                ], // 36px to 48px
